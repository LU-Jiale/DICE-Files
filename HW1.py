...
def mapping(t, q1, q2, q3, q4):
    T_base_L1 = z_offset(t[0])
    T_L1_L2 = z_offset(t[1])
    T_L2_L3 = z_offset(t[2])
    T_L3_L4 = z_offset(t[3])
    T_L4_G = z_offset(t[4])
    t = [T_base_L1, T_L1_L2, T_L2_L3, T_L3_L4, T_L4_G]
    return t[0].dot(rotate_z(q1).dot(t[1].dot(rotate_y(q2).dot(t[2].dot(rotate_y(q3).dot(t[3].dot(rotate_y(q4).dot(t[4].dot(y_init)))))))))
